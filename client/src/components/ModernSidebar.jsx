    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
          <AnimatePresence>
            {(!isCollapsed || isMobile) && !userBusiness && (
              <motion.div
                variants={menuItemVariants}
                initial="collapsed"
                animate="expanded"
          ...
          <button
            ...
            className={`w-full flex items-center ${isCollapsed && !isMobile ? 'justify-center' : ''} px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg`}
          >
          ...
          {/* Theme Toggle */}
          <div className={`flex items-center ${isCollapsed && !isMobile ? 'justify-center' : 'justify-between'} px-2 py-2`}>
            <AnimatePresence>
              {(!isCollapsed || isMobile) && (
                <motion.span
          ...
          <button
            onClick={onLogout}
            className={`w-full flex items-center ${isCollapsed && !isMobile ? 'justify-center' : ''} px-4 py-2 text-gray-600 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 rounded-lg transition-all duration-200`}
          >
            <span className="text-lg">🚪</span>
            <AnimatePresence>
              {(!isCollapsed || isMobile) && (
